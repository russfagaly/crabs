# fielding_parser.py — 2026 Project Mill Cooperstown
#
# Best-effort fielding stat extraction (PO, A, DP) from the play-by-play
# logs. Only counts plays where Project Mill are on defense (opponent batting)
# AND a Project Mill fielder is named in the play description. Many routine
...
def parse_game_fielding(game_id):
    ...
    where Project Mill were on defense and a Project Mill fielder was named."""
    stats = {}
    ...
    for half, header, blocks in innings:
        ...
        crabs_batting = 'Project Mill' in batting_team or 'Project Mill' in batting_team
        if crabs_batting:
            continue  # Project Mill at bat -> Project Mill not fielding, skip
