#!/usr/bin/env python3
"""
generate_game_pages.py — 2026 Project Mill Cooperstown
Reads each game file and produces a per-game page (games/<game_id>.html)
with the Project Mill box score (batting + pitching) and the full chronological
...
for i, (game_id, date_str, mod) in enumerate(game_files):
    ...
    res_color = 'var(--green)' if result == 'W' else 'var(--red)' if result == 'L' else 'var(--yellow)'
    ...
    title = f"vs {opp} — 2026 Project Mill Cooperstown"
...
<div class="section">
  <div class="section-title">Project Mill Batting</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="section-title">Project Mill Pitching</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="footer">2026 Project Mill Cooperstown &middot; Generated {GENERATED}</div>
</div>
