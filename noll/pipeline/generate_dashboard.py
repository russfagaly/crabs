#!/usr/bin/env python3
"""
generate_dashboard.py — 2026 NOLL 12U All-Stars
...
# ── W/L record ────────────────────────────────────────────────────────────────
wins   = sum(1 for g in GAMES if g.get('winner')=='NOLL')
losses = sum(1 for g in GAMES if g.get('winner')!='NOLL')
rs     = sum(g['away_score'] if g['away']=='NOLL' else g['home_score'] for g in GAMES) if GAMES else 0
ra     = sum(g['home_score'] if g['away']=='NOLL' else g['away_score'] for g in GAMES) if GAMES else 0
...
<html lang="en">
<head>
{theme.head('2026 NOLL 12U All-Stars')}
</head>
<body>

<div class="header">
{theme.THEME_TOGGLE_BUTTON}
  <h1>2026 NOLL 12U All-Stars</h1>
...
<div class="footer">2026 NOLL 12U All-Stars · Generated {GENERATED} · {NUM_GAMES} games</div>
</body></html>"""
