#!/usr/bin/env python3
"""
generate_game_pages.py — 2026 Road Dogs 12
Reads each game file and produces a per-game page (games/<game_id>.html)
with the Road Dogs box score (batting + pitching) and the full chronological
...
for i, (game_id, date_str, mod) in enumerate(game_files):
    ...
    title = f"vs {opp} — 2026 Road Dogs 12"
...
<div class="section">
  <div class="section-title">Road Dogs Batting</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="section-title">Road Dogs Pitching</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="footer">2026 Road Dogs 12 &middot; Generated {GENERATED}</div>
</div>
