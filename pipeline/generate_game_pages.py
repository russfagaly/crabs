#!/usr/bin/env python3
"""
generate_game_pages.py — 2026 Alameda 12u All-Stars
Reads each game file and produces a per-game page (games/<game_id>.html)
with the Crabs box score (batting + pitching) and the full chronological
...
for i, (game_id, date_str, mod) in enumerate(game_files):
    ...
    title = f"vs {opp} — 2026 Alameda 12u All-Stars"
...
<div class="section">
  <div class="section-title">Crabs Batting</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="section-title">Crabs Pitching</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="footer">2026 Alameda 12u All-Stars &middot; Generated {GENERATED}</div>
</div>
