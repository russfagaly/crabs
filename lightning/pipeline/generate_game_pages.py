#!/usr/bin/env python3
"""
generate_game_pages.py — 2026 Lafayette Lightning
Reads each game file and produces a per-game page (games/<game_id>.html)
with the Lightning box score (batting + pitching) and the full chronological
...
for i, (game_id, date_str, mod) in enumerate(game_files):
    ...
    title = f"vs {opp} — 2026 Lafayette Lightning"
...
<div class="section">
  <div class="section-title">Lightning Batting</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="section-title">Lightning Pitching</div>
  <div class="tbl-wrap">
    <table>
  ...
  <div class="footer">2026 Lafayette Lightning &middot; Generated {GENERATED}</div>
</div>
